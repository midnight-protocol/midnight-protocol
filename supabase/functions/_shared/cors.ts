...
const DEFAULT_ALLOWED_ORIGINS = [
  ...
  'https://0ace998b-9979-4091-8c2b-c2bd08562779.lovableproject.com',
  'https://*.lovable.app',
  'https://id-preview--0ace998b-9979-4091-8c2b-c2bd08562779.lovable.app',
  // Production origins
  'https://prax.pro',
  'https://www.prax.pro',
  'https://midnightprotocol.org',
  'https://www.midnightprotocol.org',
  'https://praxisnetwork.ai',
  'https://www.praxisnetwork.ai',
  'https://midnight-protocol.vercel.app', // If using Vercel
];
...
export function corsErrorResponse(
  ...
  const headers = origin && isOriginAllowed(origin) 
    ? getCorsHeaders(req) 
    : {};
