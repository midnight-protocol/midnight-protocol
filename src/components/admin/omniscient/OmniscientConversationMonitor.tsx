...
const OmniscientConversationMonitor = () => {
  const [selectedConversation, setSelectedConversation] =
    useState<OmniscientConversation | null>(null);
  ...
  const {
    ...
    queryFn: () =>
      omniscientService.getConversations({
  ...
  const { data: conversationDetails } = useQuery({
    ...
    queryFn: () =>
      selectedConversation
        ? omniscientService.getConversation(selectedConversation.id)
        : null,
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-semibold text-white">
                              {conversation.match?.user_a?.handle} ×{" "}
                              {conversation.match?.user_b?.handle}
                            </p>
                            <div className="flex items-center gap-3 mt-1">
                              ...
                              {conversation.quality_score && (
                                ...
                                >
                                  Quality:{" "}
                                  {(conversation.quality_score * 100).toFixed(
                                    1
                                  )}
                                  %
                                </span>
                              ...
                              {conversation.actual_outcome && (
                                ...
                                >
                                  {conversation.actual_outcome?.replace(
                                    "_",
                                    " "
                                  )}
                                </Badge>
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div
                                      className={`text-sm font-medium ${
                                        conversationDetails.actual_outcome
                                          ? omniscientService.getOutcomeColor(
                                              conversationDetails.actual_outcome
                                            )
                                          : "text-gray-400"
                                      }`}
                                    >
                                      {conversationDetails.actual_outcome?.replace(
                                        "_",
                                        " "
                                      ) || "Pending"}
                                    </div>
                                  ...
                                  <div className="bg-gray-700 p-3 rounded-lg">
                                    ...
                                    <div className="text-lg font-bold text-white">
                                      {conversationDetails.total_tokens?.toLocaleString() ||
                                        0}
                                    </div>
                                  </div>
                                </div>
                                ...
                                {/* Key Moments */}
                                {conversationDetails.key_moments &&
                                  conversationDetails.key_moments.length >
                                    0 && (
                                    <div>
                                      <h4 className="text-lg font-semibold text-white mb-2">
                                        Key Moments
                                      ...
                                      <div className="space-y-2">
                                        {conversationDetails.key_moments.map(
                                          (moment, index) => (
                                            <div
                                              key={index}
